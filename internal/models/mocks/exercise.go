...
var mockExercise = &MockExerciseModel{}

type MockExerciseModel struct {
	DB *pgxpool.Pool
}

func (e *MockExerciseModel) Insert(exercise domain.ExerciseRecord) (int, error) {
...
func (e *MockExerciseModel) Upsert(exercise domain.ExerciseRecord) error {
	stmt := `
...
func (e *MockExerciseModel) GetAll(f domain.ExercsiesFilter) ([]domain.ExerciseRecord, error) {
...
func (e *MockExerciseModel) GetByID(id int) (*domain.ExerciseRecord, error) {
	var exercise domain.ExerciseRecord
...
func (e *MockExerciseModel) GetByUUID(uuid string) (*domain.ExerciseRecord, error) {
	var exercise domain.ExerciseRecord
...
func (e *MockExerciseModel) Update(id int, exercise domain.ExerciseRecord) error {
	return nil
}

func (e *MockExerciseModel) Delete(id int) error {
	return nil
}
